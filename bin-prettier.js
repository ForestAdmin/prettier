...
var require_package = __commonJS2({
  "package.json"(exports2, module2) {
    module2.exports = require.call(void 0, "./package.json");
  }
});
var require_semver_compare = __commonJS2({
...
var require_please_upgrade_node = __commonJS2({
  "node_modules/please-upgrade-node/index.js"(exports2, module2) {
    var semverCompare = require_semver_compare();
    module2.exports = function pleaseUpgradeNode(pkg, opts) {
      var opts = opts || {};
...
var require_src = __commonJS2({
  "src/index.js"(exports2, module2) {
    module2.exports = require("./index.js");
  }
});
...
var require_prettier_internal = __commonJS2({
  "src/cli/prettier-internal.js"(exports2, module2) {
    "use strict";
    module2.exports = require_src().__internal;
  }
});
  ...
  "src/cli/options/option-map.js"(exports2, module2) {
    ...
    function normalizeDetailedOption(name, option) {
      return __spreadProps(__spreadValues({
        ...
        choices: option.choices && option.choices.map((choice) => {
          const newChoice = __spreadValues({
            description: "",
            deprecated: false
    ...
    function createDetailedOptionMap(supportOptions) {
      return Object.fromEntries(supportOptions.map((option) => {
        const newOption = __spreadProps(__spreadValues({}, option), {
...
var require_get_context_options = __commonJS2({
  "src/cli/options/get-context-options.js"(exports2, module2) {
    ...
    function getContextOptions(plugins, pluginSearchDirs) {
      ...
      const detailedOptionMap = normalizeDetailedOptionMap(__spreadValues(__spreadValues({}, createDetailedOptionMap(supportOptions)), constant.options));
      const detailedOptions = arrayify(detailedOptionMap, "name");
      const apiDefaultOptions = __spreadValues(__spreadValues({}, optionsModule.hiddenDefaults), Object.fromEntries(supportOptions.filter(({
        deprecated
...
var require_minimist2 = __commonJS2({
  "src/cli/options/minimist.js"(exports2, module2) {
    ...
    module2.exports = function(args, options) {
      ...
      const newDefaults = __spreadValues(__spreadValues({}, defaults), Object.fromEntries(booleanWithoutDefault.map((key) => [key, PLACEHOLDER])));
      const parsed = minimist(args, __spreadProps(__spreadValues({}, options), {
        default: newDefaults
      }));
...
var require_parse_cli_arguments = __commonJS2({
  "src/cli/options/parse-cli-arguments.js"(exports2, module2) {
    ...
    var detailedOptionsWithoutPlugins = getContextOptions().detailedOptions;
...
Defaults to ${createDefaultValueDisplay(optionDefaultValue)}.`}`, threshold);
    ...
    function getOptionsWithOpposites(options) {
      const optionsWithOpposites = options.map((option) => [option.description ? option : null, option.oppositeDescription ? __spreadProps(__spreadValues({}, option), {
        name: `no-${option.name}`,
        type: "boolean",
...
var require_third_party = __commonJS2({
  "src/common/third-party.js"(exports2, module2) {
  ...
  "node_modules/fill-range/index.js"(exports2, module2) {
    ...
    var fillNumbers = (start, end, step = 1, options = {}) => {
      ...
      if (options.toRegex === true) {
        return step > 1 ? toSequence(parts, options) : toRegex(range, null, __spreadValues({
          wrap: false
        }, options));
      }
      return range;
    ...
    var compile = (ast, options = {}) => {
      let walk = (node, parent = {}) => {
        ...
        if (node.nodes && node.ranges > 0) {
          ...
          let range = fill(...args, __spreadProps(__spreadValues({}, options), {
            wrap: false,
            toRegex: true
          }));
          if (range.length !== 0) {
  ...
  "node_modules/micromatch/index.js"(exports2, module2) {
    ...
    var micromatch = (list, patterns, options) => {
      ...
      for (let i = 0; i < patterns.length; i++) {
        let isMatch = picomatch(String(patterns[i]), __spreadProps(__spreadValues({}, options), {
          onResult
        }), true);
    ...
    micromatch.not = (list, patterns, options = {}) => {
      ...
      let matches = micromatch(list, patterns, __spreadProps(__spreadValues({}, options), {
        onResult
      }));
    ...
    micromatch.contains = (str, pattern, options) => {
      ...
      return micromatch.isMatch(str, pattern, __spreadProps(__spreadValues({}, options), {
        contains: true
      }));
    };
    ...
    micromatch.capture = (glob, input, options) => {
      ...
      let regex = picomatch.makeRe(String(glob), __spreadProps(__spreadValues({}, options), {
        capture: true
      }));
    ...
    micromatch.braceExpand = (pattern, options) => {
      if (typeof pattern !== "string")
        throw new TypeError("Expected a string");
      return micromatch.braces(pattern, __spreadProps(__spreadValues({}, options), {
        expand: true
      }));
    };
...
var require_get_options_for_file = __commonJS2({
  "src/cli/options/get-options-for-file.js"(exports2, module2) {
    ...
    function applyConfigPrecedence(context, options) {
      try {
        switch (context.argv.configPrecedence) {
          ...
          case "file-override":
            return __spreadValues(__spreadValues({}, parseArgsToOptions(context)), options);
          case "prefer-file":
    ...
    async function getOptionsForFile(context, filepath) {
      ...
      const appliedOptions = __spreadValues({
        filepath
  ...
  "src/cli/format.js"(exports2, module2) {
    ...
    function format(context, input, opt) {
      ...
      if (context.argv.debugPrintComments) {
        return {
          formatted: prettier.format(JSON.stringify(prettier.formatWithCursor(input, opt).comments || []), {
            parser: "json"
          })
        };
      }
      if (context.argv.debugPrintAst) {
        const {
          ast
        } = prettier.__debug.parse(input, opt);
        return {
      ...
      if (context.argv.debugCheck) {
        ...
        if (pp !== pppp) {
          ...
          const ast = stringify(prettier.__debug.parse(input, opt, true).ast);
          const past = stringify(prettier.__debug.parse(pp, opt, true).ast);
          if (ast !== past) {
    ...
    async function formatFiles(context) {
      ...
      for await (const pathOrError of expandPatterns(context)) {
        ...
        const options = __spreadProps(__spreadValues({}, await getOptionsForFile(context, filename)), {
          filepath: filename
        });
        let printedFilename;
        if (isTTY()) {
...
var require_file_info = __commonJS2({
  "src/cli/file-info.js"(exports2, module2) {
    ...
    async function logFileInfoOrDie(context) {
      ...
      context.logger.log(prettier.format(stringify(fileInfo), {
        parser: "json"
      }));
    }
    module2.exports = logFileInfoOrDie;
  }
});
var require_find_config_path = __commonJS2({
  "src/cli/find-config-path.js"(exports2, module2) {
    ...
    module2.exports = logResolvedConfigPathOrDie;
  }
});
var require_cli = __commonJS2({
  "src/cli/index.js"(exports2, module2) {
    "use strict";
    var packageJson = require_package();
    require_please_upgrade_node()(packageJson);
    var stringify = require_fast_json_stable_stringify();
    var prettier = require_src();
...
module.exports = require_cli().run(process.argv.slice(2));
